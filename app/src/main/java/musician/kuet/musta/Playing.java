...
public class Playing extends ListActivity implements View.OnClickListener, MediaPlayer.OnCompletionListener {
    ...
    Button playingSong, playlist_action_bar_back_btn, playlist_action_bar_search_btn, search_back_btn;
    ...
    public void initialization() {
        ...
        playlist_action_bar_search_btn = (Button) findViewById(R.id.playlist_action_bar_search_btn);
